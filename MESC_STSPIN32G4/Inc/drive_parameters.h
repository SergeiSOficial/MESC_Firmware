...
#define PID_TORQUE_KP_DEFAULT               592
#define PID_TORQUE_KI_DEFAULT               62
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 592
#define PID_FLUX_KI_DEFAULT                 62
...
#define PID_SPEED_KI_DEFAULT                2363/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
