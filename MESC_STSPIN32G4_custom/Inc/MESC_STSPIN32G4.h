...
#ifndef INC_MESC_STSPIN32G4_H_
#define INC_MESC_STSPIN32G4_H_
...
#include <math.h>
#include "MESC_STSPIN32G4_EVLSERVO1.h"
...
#define DEFAULT_INPUT	0b0010 //0b...wxyz where w is UART, x is RCPWM, y is ADC2 z is ADC1
...
#define DEADSHORT_CURRENT 1.0f	//When recovering from tracking phase without phase sensors, the
