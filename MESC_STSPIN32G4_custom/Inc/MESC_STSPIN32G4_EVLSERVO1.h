...
#define CUSTOM_DEADTIME 1800 //ns
...
#define OPGAIN 320.0f

#define R_VBUS_BOTTOM 1100.0f //Phase and Vbus voltage sensors
#define R_VBUS_TOP 22000.0f


#define MAX_ID_REQUEST 0.1f
#define MAX_IQ_REQUEST 1.0f
...
//Inputs
#define GET_THROTTLE_INPUT _motor->Raw.ADC_in_ext1 = 0  // Throttle
...
#define MAX_MOTOR_PHASE_CURRENT 40.0f //2A seems like a reasonable default for any motor
#define DEFAULT_MOTOR_POWER 1000.0f //
#define DEFAULT_FLUX_LINKAGE 0.00014195f//Could be absolutely anything.
#define DEFAULT_MOTOR_Ld 0.000022f //Henries Could be anything, but setting it low means the current controller P term will be more stable/slower
...
#define DEFAULT_MOTOR_PP 8 //Pole Pairs
...
#define ADC_OFFSET_DEFAULT 2460
