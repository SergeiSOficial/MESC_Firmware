...
#define MAX_APPLICATION_SPEED_RPM           2900 /*!< rpm, mechanical */
...
#define SW_DEADTIME_NS                      650 /*!< Dead-time to be inserted by FW, only if low side signals are enabled */
...
#define PID_TORQUE_KP_DEFAULT               1184
#define PID_TORQUE_KI_DEFAULT               123
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 1184
#define PID_FLUX_KI_DEFAULT                 123
...
#define PID_SPEED_KP_DEFAULT                2910/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                1182/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define OV_TEMPERATURE_THRESHOLD_C          86 /*!< Celsius degrees */
...
#define PHASE1_FINAL_CURRENT_A              7.81

/* Phase 2 */
#define PHASE2_DURATION                     2320 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (1160*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              7.81

/* Phase 3 */
#define PHASE3_DURATION                     0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (1160*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              7.81

/* Phase 4 */
#define PHASE4_DURATION                     0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (1160*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              7.81

/* Phase 5 */
#define PHASE5_DURATION                     0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (1160*SPEED_UNIT/U_RPM)
#define PHASE5_FINAL_CURRENT_A              7.81
...
#define OBS_MINIMUM_SPEED_RPM               1044
